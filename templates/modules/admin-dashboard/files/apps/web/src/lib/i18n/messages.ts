...
const en = {
  ...
  general: {
    ...
    appearanceTitle: "Appearance", appearanceDesc: "Theme preset, accent color, and corner radius — applied across the whole app.",
    themePreset: "Theme preset",
    accentColor: "Accent color", accentColorHint: "Overrides the preset's accent. Leave empty to use the preset default.",
    radius: "Corner radius",
    advanced: "Advanced — per-token colors", advancedHide: "Hide advanced",
    resetTheme: "Reset to preset", saveTheme: "Save appearance", restoreDefaults: "Restore defaults",
    preview: "Preview", previewLight: "Light", previewDark: "Dark",
    previewHeading: "Card heading", previewBody: "The quick brown fox jumps over the lazy dog.",
    previewPrimary: "Primary", previewOutline: "Outline", previewBadge: "Badge",
    themeTokens: {
...
const ko: Messages = {
  ...
  general: {
    ...
    brandColor: "브랜드 색상",
    appearanceTitle: "테마", appearanceDesc: "테마 프리셋·액센트 색·모서리 반경 — 앱 전체에 적용됩니다.",
    themePreset: "테마 프리셋",
    accentColor: "액센트 색상", accentColorHint: "프리셋 액센트를 덮어씁니다. 비우면 프리셋 기본값을 사용합니다.",
    radius: "모서리 반경",
    advanced: "고급 — 토큰별 색상", advancedHide: "고급 숨기기",
    resetTheme: "프리셋으로 초기화", saveTheme: "테마 저장", restoreDefaults: "기본값으로 복원",
    preview: "미리보기", previewLight: "라이트", previewDark: "다크",
    previewHeading: "카드 제목", previewBody: "다람쥐 헌 쳇바퀴에 타고파.",
    previewPrimary: "기본", previewOutline: "외곽선", previewBadge: "배지",
    themeTokens: {
