...
const en = {
  ...
  setup2fa: {
    ...
    subtitle: "This site requires two-factor authentication. Add an authenticator app to continue.",
    passwordLabel: "Confirm your password",
    begin: "Continue",
    step1: "1. Scan with your authenticator app",
    step2: "2. Save your backup codes",
    step3: "3. Enter the 6-digit code",
    savedConfirm: "I've saved my backup codes",
    activate: "Activate and continue",
    signOut: "Sign out",
    wrongPassword: "That password is incorrect.",
    enableFailed: "Couldn't start setup. Please try again.",
  },
  auth: {
    signInTitle: "Sign in",
    ...
    twoFactorInvalidCode: "That code isn't valid. Check it and try again.",
    twoFactorLocked: "Too many attempts. Please wait a moment and try again.",
    ...
    publicSignupDisabled: "Public sign-up is closed. Existing users can still sign in.",
    ...
    approvalPendingTitle: "Waiting for approval",
    approvalPendingDesc: "Your account was created and is waiting for an administrator to approve it. Try signing in again after approval.",
  ...
  general: {
    ...
    appearanceTitle: "Appearance", appearanceDesc: "Choose the base colors and corner style for the app. Changes apply after you save.",
    themePreset: "Base theme", featuredThemes: "Featured themes", moreThemes: "Show more themes", hideThemes: "Show fewer themes",
    quickSettings: "Quick settings",
    accentColor: "Brand color", accentColorHint: "Replaces the theme's primary color. Leave it empty to use the theme color.", clearColor: "Clear brand color",
    radius: "Corner style", radiusDefault: "App default", radiusNone: "Square", radiusSmall: "Small", radiusMedium: "Medium", radiusLarge: "Large",
    advanced: "Fine-tune colors", advancedHide: "Close color settings",
    resetTheme: "Clear color adjustments", saveTheme: "Save changes", restoreDefaults: "Restore defaults",
    preview: "Preview", previewLight: "Light", previewDark: "Dark",
    previewApp: "Workspace", previewNav: "Overview", previewSettings: "Settings",
    previewHeading: "Theme preview", previewBody: "Colors and corner styles are shown here before you save.",
    previewPrimary: "Save", previewOutline: "Cancel", previewBadge: "Active",
    themeTokens: {
      background: "Background", card: "Card", foreground: "Foreground",
      mutedForeground: "Muted text", border: "Border", secondary: "Secondary",
      accent: "Accent", primary: "Primary", primaryForeground: "Primary text",
    },
  ...
  settings: {
    ...
    signupApproval: "Sign-up approval", signupApprovalDesc: "Require an administrator to approve new self-registered users. Disabling this only affects future registrations.",
    ...
    require2fa: "Require two-factor", require2faDesc: "Every user must enrol in 2FA after signing up before using the app.",
...
const ko: Messages = {
  ...
  setup2fa: {
    title: "2단계 인증 설정",
    subtitle: "이 사이트는 2단계 인증이 필수입니다. 계속하려면 인증 앱을 등록하세요.",
    passwordLabel: "비밀번호 확인",
    begin: "계속",
    step1: "1. 인증 앱으로 스캔",
    step2: "2. 백업 코드 저장",
    step3: "3. 6자리 코드 입력",
    savedConfirm: "백업 코드를 저장했습니다",
    activate: "활성화하고 계속",
    signOut: "로그아웃",
    wrongPassword: "비밀번호가 올바르지 않습니다.",
    enableFailed: "설정을 시작할 수 없습니다. 다시 시도해 주세요.",
  },
  auth: {
    signInTitle: "로그인",
    ...
    twoFactorInvalidCode: "코드가 올바르지 않습니다. 다시 확인해 주세요.",
    twoFactorLocked: "시도가 너무 많습니다. 잠시 후 다시 시도해 주세요.",
    noAccount: "계정이 없으신가요?",
    signUp: "회원가입",
    ...
    approvalPendingTitle: "승인 대기 중",
    approvalPendingDesc: "계정이 생성되었으며 관리자의 승인을 기다리고 있습니다. 승인 후 다시 로그인해 주세요.",
    approvalPending: "관리자의 계정 승인을 기다리고 있습니다.",
    publicSignupDisabled: "공개 가입이 닫혀 있습니다. 기존 사용자는 계속 로그인할 수 있습니다.",
  ...
  general: {
    ...
    brandColor: "브랜드 색상",
    appearanceTitle: "화면 테마", appearanceDesc: "앱의 기본 색상과 모서리 형태를 설정합니다. 저장하면 모든 화면에 적용됩니다.",
    themePreset: "기본 테마", featuredThemes: "주요 테마", moreThemes: "테마 더 보기", hideThemes: "테마 접기",
    quickSettings: "빠른 설정",
    accentColor: "브랜드 색상", accentColorHint: "선택한 테마의 주요 색상을 바꿉니다. 비우면 테마 색상을 사용합니다.", clearColor: "브랜드 색상 지우기",
    radius: "모서리 형태", radiusDefault: "앱 기본값", radiusNone: "각지게", radiusSmall: "작게", radiusMedium: "보통", radiusLarge: "크게",
    advanced: "세부 색상 설정", advancedHide: "세부 설정 닫기",
    resetTheme: "세부 색상 지우기", saveTheme: "변경 저장", restoreDefaults: "기본값으로 복원",
    preview: "미리보기", previewLight: "라이트", previewDark: "다크",
    previewApp: "워크스페이스", previewNav: "대시보드", previewSettings: "설정",
    previewHeading: "테마 미리보기", previewBody: "저장하기 전에 색상과 모서리 형태를 확인할 수 있습니다.",
    previewPrimary: "저장", previewOutline: "취소", previewBadge: "사용 중",
    themeTokens: {
      background: "배경", card: "카드", foreground: "전경(글자)",
      mutedForeground: "흐린 글자", border: "테두리", secondary: "보조",
      accent: "강조", primary: "기본", primaryForeground: "기본 글자",
    },
  ...
  settings: {
    ...
    signupApproval: "회원가입 승인", signupApprovalDesc: "신규 자가 가입 사용자를 관리자가 승인해야 로그인할 수 있습니다. 끄면 이후 가입부터 자동 승인됩니다.",
    ...
    require2fa: "2FA 필수화", require2faDesc: "모든 사용자가 가입 후 2FA를 등록해야 앱을 사용할 수 있습니다.",
